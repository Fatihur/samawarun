...
class ParticipantVerifiedNotification extends Notification implements
    ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail->subject("Pembayaran disetujui, pendaftaran Anda lengkap");
        $mail->view("emails.participant-status-updated", [
            ...
            "footerMessage" =>
                "Simpan email ini sebagai bukti pendaftaran resmi. Tunjukkan QR Code dan BIB saat diperlukan pada hari pelaksanaan.",
            "barcode" => $barcode,
            "barcodeValue" => $barcodeValue,
        ]);
        $mail->attachData($pdf, $fileName, [
