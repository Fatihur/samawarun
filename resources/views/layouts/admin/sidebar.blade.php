...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 shrink-0 transform bg-slate-900 px-4 py-6 text-slate-300 transition-transform duration-300 lg:static lg:translate-x-0 flex flex-col border-r border-slate-800 shadow-xl lg:shadow-none">
    ...
    <nav class="flex-1 space-y-1.5 overflow-y-auto font-medium text-sm pb-8">
        ...
        <a href="{{ route('admin.dashboard') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.events.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.events.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.participants.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.participants.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.distance-categories.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.distance-categories.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.bib-settings.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.bib-settings.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
            <x-heroicon-o-tag class="h-5 w-5 {{ request()->routeIs('admin.bib-settings.*') ? 'text-brand-500' : 'text-slate-400 group-hover:text-white' }}" />
            Pengaturan BIB
        </a>
        <a href="{{ route('admin.bib-scan.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.bib-scan.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.race-timing.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.race-timing.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
            <x-heroicon-o-clock class="h-5 w-5 {{ request()->routeIs('admin.race-timing.*') ? 'text-brand-500' : 'text-slate-400 group-hover:text-white' }}" />
            Catat Waktu Race
        </a>
        <a href="{{ route('admin.race-reports.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.race-reports.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.certificates.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.certificates.*') || request()->routeIs('admin.participants.certificate') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
        ...
        <a href="{{ route('admin.contacts.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.contacts.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
            <x-heroicon-o-phone class="h-5 w-5 {{ request()->routeIs('admin.contacts.*') ? 'text-brand-500' : 'text-slate-400 group-hover:text-white' }}" />
            Kontak & Header
        </a>
        <a href="{{ route('admin.gallery.index') }}" wire:navigate wire:current="bg-brand-500/10 text-brand-400" class="group flex items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {{ request()->routeIs('admin.gallery.*') ? 'bg-brand-500/10 text-brand-400' : 'hover:bg-slate-800 hover:text-white' }}">
