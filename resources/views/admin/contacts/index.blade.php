...
@section('content')
    ...
    <form action="{{ route('admin.contacts.update') }}" method="POST" class="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
        @csrf
        @method('PUT')
        ...
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                <button type="submit" class="rounded-xl bg-brand-600 px-6 py-3 text-sm font-bold text-white shadow-sm transition-all hover:bg-brand-700 active:scale-95">Simpan Kontak</button>
            </div>
        </div>
    </form>
@endsection
